...
#include "ui_admineditCity.h"



adminEditData::adminEditData(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::adminEditData)
{
    ui->setupUi(this);
    setUpPage();
}
...
void adminEditData::addNewCityAndFood()
{

}

void adminEditData::on_updateButton_clicked()
{
    data.close();
...
void adminEditData::on_showAll_clicked()
{
    //close database
       data.close();
       data.removeDatabase("first");
